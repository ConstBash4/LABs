package ru.vasilkov.Service2.controller;
...
import ru.vasilkov.Service2.model.*;
import ru.vasilkov.Service2.service.ValidationService;
...
public class myController {
    ...
    public ResponseEntity<Response> feedback(@Valid @RequestBody Request request, BindingResult bindingResult) {
        ...
        String timeRequest = request.getSystemTime();
        ...
        try {
            ...
            DateTimeUtil.timeDifference(timeRequest, timeNow);
